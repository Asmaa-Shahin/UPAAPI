    ...
    public class AssetDetailsController : ControllerBase
    {
        ...
        public ActionResult Add(CreateAssetDetailVM AssetDetailVM)
        {
            ...
            else
            {
                ...
                if (AssetDetailVM.PurchaseDate == "")
                {
                    AssetDetailVM.PurchaseDate = "01/01/1900";

                }
                if (AssetDetailVM.InstallationDate == "")
                {
                    AssetDetailVM.InstallationDate = "01/01/1900";
        ...
        [HttpPost]
        [Route("GetAssetsByAgeGroup")]
        public List<HospitalAssetAge> GetAssetsByAgeGroup(ChartFilter filter)
        {
            var list = _assetDetailService.GetAssetsByAgeGroup(filter);
            return list;
        }
        [HttpPost]
        ...
        [HttpGet("DrawingChart")]

        public ActionResult<List<DrawChart>> DrawingChart()
        {

            return _assetDetailService.DrawingChart();
        }
        [HttpGet("DrawingChartByGov")]

        public ActionResult<List<DrawChartByGov>> DrawingChartByGov()
        {

            return _assetDetailService.DrawingChartByGov();
        }
        [HttpPost("DrawChartForGovAndPopulation")]
        public ActionResult<List<DrawChartForGovAndPopulation>> DrawChartForGovAndPopulation(ChartFilter chartFilter)
        {


            return _assetDetailService.DrawChartForGovAndPopulation(chartFilter);
        }
        [HttpPost]
        [Route("SortAssetsafterSearch/{pageNumber}/{pageSize}")]
        public IndexAssetDetailVM SortAssetsafterSearch(FilterAndSortVMAssets data, int pageNumber, int pageSize)
       {

            return _assetDetailService.SortAssetsafterSearch(data, pageNumber, pageSize);
        }
    }
}
